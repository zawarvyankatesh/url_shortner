...
class Settings(BaseSettings):
    ...
    llm_endpoint: str = "https://llm-proxy.internal:8085"
    llm_api_version: str = "2024-02-15-preview"
    llm_model: str = "gpt-4.1"
    llm_api_key: str = ""
    llm_ntnet_user: str = "user@example.com"
    ...
    # --- Email (SMTP) ---
    mail_to: str = "oncall@example.com"
    mail_from: str = "incident-agent@example.com"
    smtp_host: str = ""
    smtp_port: int = 25
    smtp_user: str = ""
    smtp_password: str = ""
